...
public class Log
{
    ...
    [Flags]
    public enum Category { Console = 1, System = 2, GUI = 4, AI = 8, Network = 16, Physics = 32, General = 64, Animation = 128, Sound = 256, Camera = 512 };
    [Flags]
    public enum Options { UseConsole = 1, ShowPrefix = 2 };
