...
public class UnityEngine_RenderTextureWrap
{
	...
	static int GetTemporary(IntPtr L)
	{
		try
		{
			...
			else if (count == 6 && TypeChecker.CheckTypes<int, int, int, UnityEngine.RenderTextureFormat, UnityEngine.RenderTextureReadWrite, int>(L, 1))
			{
				int arg0 = (int)LuaDLL.lua_tonumber(L, 1);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 2);
				int arg2 = (int)LuaDLL.lua_tonumber(L, 3);
	...
	static int DiscardContents(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.RenderTexture, bool, bool>(L, 1))
			{
				UnityEngine.RenderTexture obj = (UnityEngine.RenderTexture)ToLua.ToObject(L, 1);
