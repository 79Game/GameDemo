...
public class UnityEngine_RigidbodyWrap
{
	...
	static int AddForce(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.Rigidbody, UnityEngine.Vector3>(L, 1))
			{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Rigidbody, UnityEngine.Vector3, UnityEngine.ForceMode>(L, 1))
			{
				UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
			...
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.Rigidbody, float, float, float>(L, 1))
			{
				UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
			...
			else if (count == 5 && TypeChecker.CheckTypes<UnityEngine.Rigidbody, float, float, float, UnityEngine.ForceMode>(L, 1))
			{
				UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
				float arg0 = (float)LuaDLL.lua_tonumber(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
	...
	static int AddForceAtPosition(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Rigidbody, UnityEngine.Vector3, UnityEngine.Vector3>(L, 1))
			{
				UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
			...
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.Rigidbody, UnityEngine.Vector3, UnityEngine.Vector3, UnityEngine.ForceMode>(L, 1))
			{
				UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				UnityEngine.Vector3 arg1 = ToLua.ToVector3(L, 3);
	...
	static int AddExplosionForce(IntPtr L)
	{
		try
		{
			...
			if (count == 4 && TypeChecker.CheckTypes<UnityEngine.Rigidbody, float, UnityEngine.Vector3, float>(L, 1))
			{
				UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
				float arg0 = (float)LuaDLL.lua_tonumber(L, 2);
				UnityEngine.Vector3 arg1 = ToLua.ToVector3(L, 3);
			...
			else if (count == 5 && TypeChecker.CheckTypes<UnityEngine.Rigidbody, float, UnityEngine.Vector3, float, float>(L, 1))
			{
				UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
				float arg0 = (float)LuaDLL.lua_tonumber(L, 2);
				UnityEngine.Vector3 arg1 = ToLua.ToVector3(L, 3);
			...
			else if (count == 6 && TypeChecker.CheckTypes<UnityEngine.Rigidbody, float, UnityEngine.Vector3, float, float, UnityEngine.ForceMode>(L, 1))
			{
				UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
				float arg0 = (float)LuaDLL.lua_tonumber(L, 2);
				UnityEngine.Vector3 arg1 = ToLua.ToVector3(L, 3);
	...
	static int SweepTest(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Rigidbody, UnityEngine.Vector3, LuaInterface.LuaOut<UnityEngine.RaycastHit>>(L, 1))
			{
				UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
			...
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.Rigidbody, UnityEngine.Vector3, LuaInterface.LuaOut<UnityEngine.RaycastHit>, float>(L, 1))
			{
				UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				UnityEngine.RaycastHit arg1;
			...
			else if (count == 5 && TypeChecker.CheckTypes<UnityEngine.Rigidbody, UnityEngine.Vector3, LuaInterface.LuaOut<UnityEngine.RaycastHit>, float, UnityEngine.QueryTriggerInteraction>(L, 1))
			{
				UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				UnityEngine.RaycastHit arg1;
	...
	static int SweepTestAll(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Rigidbody, UnityEngine.Vector3, float>(L, 1))
			{
				UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
			...
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.Rigidbody, UnityEngine.Vector3, float, UnityEngine.QueryTriggerInteraction>(L, 1))
			{
				UnityEngine.Rigidbody obj = (UnityEngine.Rigidbody)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
