...
public class UnityEngine_TransformWrap
{
	...
	static int SetParent(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Transform, UnityEngine.Transform, bool>(L, 1))
			{
				UnityEngine.Transform obj = (UnityEngine.Transform)ToLua.ToObject(L, 1);
				UnityEngine.Transform arg0 = (UnityEngine.Transform)ToLua.ToObject(L, 2);
	...
	static int Translate(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.Transform, UnityEngine.Vector3>(L, 1))
			{
				UnityEngine.Transform obj = (UnityEngine.Transform)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Transform, UnityEngine.Vector3, UnityEngine.Transform>(L, 1))
			{
				UnityEngine.Transform obj = (UnityEngine.Transform)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Transform, UnityEngine.Vector3, UnityEngine.Space>(L, 1))
			{
				UnityEngine.Transform obj = (UnityEngine.Transform)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
			...
			else if (count == 5 && TypeChecker.CheckTypes<UnityEngine.Transform, float, float, float, UnityEngine.Transform>(L, 1))
			{
				UnityEngine.Transform obj = (UnityEngine.Transform)ToLua.ToObject(L, 1);
				float arg0 = (float)LuaDLL.lua_tonumber(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
			...
			else if (count == 5 && TypeChecker.CheckTypes<UnityEngine.Transform, float, float, float, UnityEngine.Space>(L, 1))
			{
				UnityEngine.Transform obj = (UnityEngine.Transform)ToLua.ToObject(L, 1);
				float arg0 = (float)LuaDLL.lua_tonumber(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
	...
	static int Rotate(IntPtr L)
	{
		try
		{
			...
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.Transform, UnityEngine.Vector3, float, UnityEngine.Space>(L, 1))
			{
				UnityEngine.Transform obj = (UnityEngine.Transform)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
	...
	static int LookAt(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Transform, UnityEngine.Vector3, UnityEngine.Vector3>(L, 1))
			{
				UnityEngine.Transform obj = (UnityEngine.Transform)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				UnityEngine.Vector3 arg1 = ToLua.ToVector3(L, 3);
