...
public class UnityEngine_ParticleSystemWrap
{
	...
	static int Simulate(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.ParticleSystem, float>(L, 1))
			{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.ParticleSystem, float, bool>(L, 1))
			{
				UnityEngine.ParticleSystem obj = (UnityEngine.ParticleSystem)ToLua.ToObject(L, 1);
				float arg0 = (float)LuaDLL.lua_tonumber(L, 2);
			...
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.ParticleSystem, float, bool, bool>(L, 1))
			{
				UnityEngine.ParticleSystem obj = (UnityEngine.ParticleSystem)ToLua.ToObject(L, 1);
				float arg0 = (float)LuaDLL.lua_tonumber(L, 2);
				bool arg1 = LuaDLL.lua_toboolean(L, 3);
			...
			else if (count == 5 && TypeChecker.CheckTypes<UnityEngine.ParticleSystem, float, bool, bool, bool>(L, 1))
			{
				UnityEngine.ParticleSystem obj = (UnityEngine.ParticleSystem)ToLua.ToObject(L, 1);
				float arg0 = (float)LuaDLL.lua_tonumber(L, 2);
				bool arg1 = LuaDLL.lua_toboolean(L, 3);
	...
	static int Emit(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.ParticleSystem, int>(L, 1))
			{
				UnityEngine.ParticleSystem obj = (UnityEngine.ParticleSystem)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.ParticleSystem, UnityEngine.ParticleSystem.EmitParams, int>(L, 1))
			{
				UnityEngine.ParticleSystem obj = (UnityEngine.ParticleSystem)ToLua.ToObject(L, 1);
