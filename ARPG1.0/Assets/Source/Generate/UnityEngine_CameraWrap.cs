...
public class UnityEngine_CameraWrap
{
	...
	static int SetTargetBuffers(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Camera, UnityEngine.RenderBuffer[], UnityEngine.RenderBuffer>(L, 1))
			{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Camera, UnityEngine.RenderBuffer, UnityEngine.RenderBuffer>(L, 1))
			{
				UnityEngine.Camera obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
	...
	static int RenderToCubemap(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.Camera, UnityEngine.RenderTexture>(L, 1))
			{
				UnityEngine.Camera obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes<UnityEngine.Camera, UnityEngine.Cubemap>(L, 1))
			{
				UnityEngine.Camera obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Camera, UnityEngine.RenderTexture, int>(L, 1))
			{
				UnityEngine.Camera obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
				UnityEngine.RenderTexture arg0 = (UnityEngine.RenderTexture)ToLua.ToObject(L, 2);
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Camera, UnityEngine.Cubemap, int>(L, 1))
			{
				UnityEngine.Camera obj = (UnityEngine.Camera)ToLua.ToObject(L, 1);
				UnityEngine.Cubemap arg0 = (UnityEngine.Cubemap)ToLua.ToObject(L, 2);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
	...
	static int set_onPreCull(IntPtr L)
	{
		try
		{
			...
			else
			{
				...
				arg0 = (UnityEngine.Camera.CameraCallback)DelegateTraits<UnityEngine.Camera.CameraCallback>.Create(func);
			}
