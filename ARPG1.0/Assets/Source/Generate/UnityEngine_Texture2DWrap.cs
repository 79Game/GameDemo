...
public class UnityEngine_Texture2DWrap
{
	...
	static int _CreateUnityEngine_Texture2D(IntPtr L)
	{
		try
		{
			...
			else if (count == 4 && TypeChecker.CheckTypes<int, int, UnityEngine.TextureFormat, bool>(L, 1))
			{
			...
			else if (count == 5 && TypeChecker.CheckTypes<int, int, UnityEngine.TextureFormat, bool, bool>(L, 1))
			{
				int arg0 = (int)LuaDLL.lua_tonumber(L, 1);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 2);
				UnityEngine.TextureFormat arg2 = (UnityEngine.TextureFormat)ToLua.ToObject(L, 3);
	...
	static int SetPixels(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.Texture2D, UnityEngine.Color[]>(L, 1))
			{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Texture2D, UnityEngine.Color[], int>(L, 1))
			{
				UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
				UnityEngine.Color[] arg0 = ToLua.ToStructArray<UnityEngine.Color>(L, 2);
			...
			else if (count == 6 && TypeChecker.CheckTypes<UnityEngine.Texture2D, int, int, int, int, UnityEngine.Color[]>(L, 1))
			{
				UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
			...
			else if (count == 7 && TypeChecker.CheckTypes<UnityEngine.Texture2D, int, int, int, int, UnityEngine.Color[], int>(L, 1))
			{
				UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
				int arg0 = (int)LuaDLL.lua_tonumber(L, 2);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
	...
	static int LoadImage(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.Texture2D, byte[]>(L, 1))
			{
				UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Texture2D, byte[], bool>(L, 1))
			{
				UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
				byte[] arg0 = ToLua.CheckByteBuffer(L, 2);
	...
	static int LoadRawTextureData(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Texture2D, System.IntPtr, int>(L, 1))
			{
				UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
				System.IntPtr arg0 = ToLua.CheckIntPtr(L, 2);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
	...
	static int GetPixels(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes<UnityEngine.Texture2D, int>(L, 1))
			{
				UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
				int arg0 = (int)LuaDLL.lua_tonumber(L, 2);
			...
			else if (count == 5 && TypeChecker.CheckTypes<UnityEngine.Texture2D, int, int, int, int>(L, 1))
			{
				UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
				int arg0 = (int)LuaDLL.lua_tonumber(L, 2);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
			...
			else if (count == 6 && TypeChecker.CheckTypes<UnityEngine.Texture2D, int, int, int, int, int>(L, 1))
			{
				UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
				int arg0 = (int)LuaDLL.lua_tonumber(L, 2);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
	...
	static int Resize(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Texture2D, int, int>(L, 1))
			{
				UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
				int arg0 = (int)LuaDLL.lua_tonumber(L, 2);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
			...
			else if (count == 5 && TypeChecker.CheckTypes<UnityEngine.Texture2D, int, int, UnityEngine.TextureFormat, bool>(L, 1))
			{
				UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
				int arg0 = (int)LuaDLL.lua_tonumber(L, 2);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
	...
	static int PackTextures(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Texture2D, UnityEngine.Texture2D[], int>(L, 1))
			{
				UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
			...
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.Texture2D, UnityEngine.Texture2D[], int, int>(L, 1))
			{
				UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
				UnityEngine.Texture2D[] arg0 = ToLua.ToObjectArray<UnityEngine.Texture2D>(L, 2);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
			...
			else if (count == 5 && TypeChecker.CheckTypes<UnityEngine.Texture2D, UnityEngine.Texture2D[], int, int, bool>(L, 1))
			{
				UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
				UnityEngine.Texture2D[] arg0 = ToLua.ToObjectArray<UnityEngine.Texture2D>(L, 2);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
	...
	static int ReadPixels(IntPtr L)
	{
		try
		{
			...
			if (count == 4 && TypeChecker.CheckTypes<UnityEngine.Texture2D, UnityEngine.Rect, int, int>(L, 1))
			{
				UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
			...
			else if (count == 5 && TypeChecker.CheckTypes<UnityEngine.Texture2D, UnityEngine.Rect, int, int, bool>(L, 1))
			{
				UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.ToObject(L, 1);
				UnityEngine.Rect arg0 = StackTraits<UnityEngine.Rect>.To(L, 2);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
