...
public class UnityEngine_WWWWrap
{
	...
	static int _CreateUnityEngine_WWW(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes<string, byte[], System.Collections.Generic.Dictionary<string,string>>(L, 1))
			{
				string arg0 = ToLua.ToString(L, 1);
				byte[] arg1 = ToLua.CheckByteBuffer(L, 2);
				System.Collections.Generic.Dictionary<string,string> arg2 = (System.Collections.Generic.Dictionary<string,string>)ToLua.ToObject(L, 3);
	...
	static int GetAudioClip(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.WWW, bool>(L, 1))
			{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.WWW, bool, bool>(L, 1))
			{
				UnityEngine.WWW obj = (UnityEngine.WWW)ToLua.ToObject(L, 1);
				bool arg0 = LuaDLL.lua_toboolean(L, 2);
			...
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.WWW, bool, bool, UnityEngine.AudioType>(L, 1))
			{
				UnityEngine.WWW obj = (UnityEngine.WWW)ToLua.ToObject(L, 1);
				bool arg0 = LuaDLL.lua_toboolean(L, 2);
				bool arg1 = LuaDLL.lua_toboolean(L, 3);
	...
	static int GetAudioClipCompressed(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes<UnityEngine.WWW>(L, 1))
			{
				UnityEngine.WWW obj = (UnityEngine.WWW)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes<UnityEngine.WWW, bool>(L, 1))
			{
				UnityEngine.WWW obj = (UnityEngine.WWW)ToLua.ToObject(L, 1);
				bool arg0 = LuaDLL.lua_toboolean(L, 2);
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.WWW, bool, UnityEngine.AudioType>(L, 1))
			{
				UnityEngine.WWW obj = (UnityEngine.WWW)ToLua.ToObject(L, 1);
				bool arg0 = LuaDLL.lua_toboolean(L, 2);
	...
	static int LoadFromCacheOrDownload(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<string, UnityEngine.Hash128>(L, 1))
			{
				string arg0 = ToLua.ToString(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes<string, UnityEngine.Hash128, uint>(L, 1))
			{
				string arg0 = ToLua.ToString(L, 1);
				UnityEngine.Hash128 arg1 = StackTraits<UnityEngine.Hash128>.To(L, 2);
			...
			else if (count == 3 && TypeChecker.CheckTypes<string, int, uint>(L, 1))
			{
				string arg0 = ToLua.ToString(L, 1);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 2);
				uint arg2 = (uint)LuaDLL.lua_tonumber(L, 3);
