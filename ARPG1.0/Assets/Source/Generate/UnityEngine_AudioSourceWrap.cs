...
public class UnityEngine_AudioSourceWrap
{
	...
	static int Play(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes<UnityEngine.AudioSource>(L, 1))
			{
				UnityEngine.AudioSource obj = (UnityEngine.AudioSource)ToLua.ToObject(L, 1);
				obj.Play();
				return 0;
			}
			else if (count == 2 && TypeChecker.CheckTypes<UnityEngine.AudioSource, ulong>(L, 1))
			{
				UnityEngine.AudioSource obj = (UnityEngine.AudioSource)ToLua.ToObject(L, 1);
	...
	static int PlayOneShot(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.AudioSource, UnityEngine.AudioClip>(L, 1))
			{
				UnityEngine.AudioSource obj = (UnityEngine.AudioSource)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.AudioSource, UnityEngine.AudioClip, float>(L, 1))
			{
				UnityEngine.AudioSource obj = (UnityEngine.AudioSource)ToLua.ToObject(L, 1);
				UnityEngine.AudioClip arg0 = (UnityEngine.AudioClip)ToLua.ToObject(L, 2);
	...
	static int PlayClipAtPoint(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.AudioClip, UnityEngine.Vector3>(L, 1))
			{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.AudioClip, UnityEngine.Vector3, float>(L, 1))
			{
				UnityEngine.AudioClip arg0 = (UnityEngine.AudioClip)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg1 = ToLua.ToVector3(L, 2);
