...
public class UnityEngine_MonoBehaviourWrap
{
	...
	static int StartCoroutine(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.MonoBehaviour, string>(L, 1))
			{
				UnityEngine.MonoBehaviour obj = (UnityEngine.MonoBehaviour)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
			...
			else if (count == 2 && TypeChecker.CheckTypes<UnityEngine.MonoBehaviour, System.Collections.IEnumerator>(L, 1))
			{
				UnityEngine.MonoBehaviour obj = (UnityEngine.MonoBehaviour)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.MonoBehaviour, string, object>(L, 1))
			{
				UnityEngine.MonoBehaviour obj = (UnityEngine.MonoBehaviour)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
	...
	static int StopCoroutine(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.MonoBehaviour, UnityEngine.Coroutine>(L, 1))
			{
				UnityEngine.MonoBehaviour obj = (UnityEngine.MonoBehaviour)ToLua.ToObject(L, 1);
